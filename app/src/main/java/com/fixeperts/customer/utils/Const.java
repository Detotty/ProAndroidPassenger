package com.fixeperts.customer.utils;
...
public class Const {
	...
	// temp key
	public static final String PLACES_AUTOCOMPLETE_API_KEY = "AIzaSyDPqeuQThnQlKJ-r4pabWTOakcXA025ArQ";
	...
	/*public static final String PUBLISHABLE_KEY = "pk_test_76pSBqUJPUwF7E3v6wIJ8WjT"; new*/


	// web services
	public class ServiceType {
		//private static final String HOST_URL = "http://booktaxi.ie/";
		private static final String HOST_URL = "http://fixexperts.com/";
	...
	public class Params {
		...
		public static final String PAYMENT_OPT = "payment_mode";
