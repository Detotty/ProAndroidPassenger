...
import com.fixeperts.customer.adapter.DrawerAdapter;
import com.fixeperts.customer.component.MyFontPopUpTextView;
import com.fixeperts.customer.db.DBHelper;
import com.fixeperts.customer.fragments.UberFeedbackFragment;
import com.fixeperts.customer.fragments.UberMapFragment;
import com.fixeperts.customer.fragments.UberTripFragment;
...
public class MainDrawerActivity extends ActionBarBaseActivitiy {
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		 ...
		 if(requestCode == 111){
			 Fragment fragmentpaypal = getSupportFragmentManager().findFragmentByTag("FRAGMENT_FEEDBACK");
			 fragmentpaypal.onActivityResult(requestCode, resultCode, data);
