...
import com.fixeperts.customer.adapter.PaymentListAdapter;
...
public class UberViewPaymentActivity extends ActionBarBaseActivitiy {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new PaymentListAdapter(this, listCards, new PreferenceHelper(this).getDefaultCard());
	...
	public void onClick(View v) {
		...
		case R.id.tvAddNewPayment:
			startActivityForResult(new Intent(this,UberAddPaymentActivity.class), REQUEST_ADD_CARD);
			break;
		default:
			break;
		}
